  ...
  try {
    ...
    if (json.formats && Array.isArray(json.formats)) {
      ...
      formats.push({
        ...
        url: fmt4k?.url || json.url || url.trim(),
      });
      ...
      formats.push({
        ...
        url: fmt1080?.url || json.url || url.trim(),
      });
      ...
      formats.push({
        ...
        url: fmt720?.url || json.url || url.trim(),
      });
      ...
      formats.push({
        ...
        url: fmt480?.url || json.url || url.trim(),
      });
      ...
      formats.push({
        ...
        url: fmtAudio?.url || json.url || url.trim(),
        isAudioOnly: true,
      });
    } else {
